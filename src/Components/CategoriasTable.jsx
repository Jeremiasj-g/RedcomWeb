...
import { ESCALAS } from '../utils/constants.js'; // ✅ importante
...
const CategoriasTable = () => {
  ...
  return (
    <>
      <h2 className="text-2xl mb-4 font-bold">Escalas de Evaluación</h2>

      <section className="sticky top-21 z-10 bg-white pb-4 shadow-sm overflow-x-auto rounded-lg">
        <table className="min-w-full text-sm text-left mt-2">
          <thead className="text-gray-700 uppercase bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-2">% Exhibición</th>
            ...
            {ESCALAS.map((obj, i) => {
              ...
              return (
                <tr key={i} className="odd:bg-white even:bg-gray-50">
                  ...
                  <td className="px-4 py-2">{c.facturacion}</td>
                  <td className="px-4 py-2">{c.horario_ruta && "✔"}</td>
                  <td className="px-4 py-2">{c.efectividad && "✔"}</td>
                  <td className="px-4 py-2">{c.eficiencia}%</td>
                  <td className="px-4 py-2">{c.cobertura}</td>
                  <td className="px-4 py-2">{c.volumen}</td>
                  <td className="px-4 py-2">{c.pop}%</td>
                  <td className="px-4 py-2">{c.exhibicion}%</td>
